...
public class SentiWordNetDemoCode {
	...
	public static double getSentiScore(String token,String pos) throws IOException {


		String pathToSWN = "C:\\Users\\Administrator\\Desktop\\SentiWordNet_3.0.0_20130122.txt";
		SentiWordNetDemoCode sentiwordnet = new SentiWordNetDemoCode(pathToSWN);
		return sentiwordnet.extract(token, pos);
	}
}