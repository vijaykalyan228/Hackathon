...
public class ParseTreeClassifier {
	...
	public static void getScore(String input,String output) throws Exception{
		Scanner in = new Scanner(new FileReader(new File(input)));//"C:\\Users\\Administrator\\Desktop\\dataset.txt"
		PrintWriter out = new PrintWriter(new FileWriter(new File(output)));//"C:\\Users\\Administrator\\Desktop\\myoutput.txt"
		String text = "";
		/*int lines=0;
		...
		out.println("\nAccuracy:\t"+((lines-(p+o+n))/(lines*1.0)));
		out.println("P: "+p+" O: "+o+" N: "+n);
